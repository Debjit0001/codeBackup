...
public class Main {
    ...
    // Java doesn't support Multiple and Hybrid inheritance because of the possibility of ambiguity among the elements of base classes. To implement those sort of techniques, INTERFACES are used.
